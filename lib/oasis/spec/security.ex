defmodule Oasis.Spec.Security do
  ...
  def build(%{"security" => security_requirement_objects}, security_schemes)
      when is_map(security_schemes) and security_schemes != %{} and
             is_list(security_requirement_objects) do
  ...
  defp supported_security?(%{"type" => "http", "scheme" => "hmac-" <> algorithm})
       when algorithm in @hmac_algorithms_supported, do: true
